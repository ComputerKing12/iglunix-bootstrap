...
git clone https://github.com/12101111/musl-malloc $SOURCES/musl-$MUSL_VER
...
curl -L "https://git.alpinelinux.org/aports/plain/main/musl/__stack_chk_fail_local.c" -o $SOURCES/__stack_chk_fail_local.c
